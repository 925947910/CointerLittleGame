...
get_data(2)->#snake_game{id=2,coin=1000,maxPlayer=15,minPlayer=2,totalScore=5000};
get_data(3)->#snake_game{id=3,coin=5000,maxPlayer=15,minPlayer=2,totalScore=5000};
